...
#define LOADSKY_SIGNATURE "\x55\x48\x8D\x05\xC1\xAA\x7D\x00\x4C\x8D\x05\xBA\xAA\x7D\x00\x48\x89\xE5\x41\x55\x41\x54\x49\x89\xFD"
#define LOADSKY_MASK "x??????????????xxxxxxxxxx"
