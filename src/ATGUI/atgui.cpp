...
char* Settings::Watermark::text = strdup("420Project / Private Build");
...
{
	if (UI::isVisible) {
		Draw::ImDrawText(ImVec2(4.f, 4.f), ImColor(255, 255, 255, 255), "Clique com o botão direito do mouse para abrir os outros menus ", NULL, 0.0f, NULL, ImFontFlags_Shadow);
		return;
	}
