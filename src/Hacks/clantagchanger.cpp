...
std::vector<ClanTagChanger::Animation> ClanTagChanger::animations = {
	ClanTagChanger::Marquee("420Project", L"4:20Project"),
	ClanTagChanger::Words("420", L"You spin me right round baby right round like a record baby right round _round __round"),
	ClanTagChanger::Letters("420Project", L"4:20Project")
};
		...
		switch (Settings::ClanTagChanger::type)
		{
			...
			case ClanTagType::LETTERS:
				*ClanTagChanger::animation = ClanTagChanger::Letters("CUSTOM", wc);
				break;
			case ClanTagType::LOADING:
				*ClanTagChanger::animation = ClanTagChanger::Loading("CUSTOM", wc);
				break;
			default:
				break;
		}
