...
int __attribute__((constructor)) AyyTuxInit()
{
	...
	cvar->ConsoleColorPrintf(ColorRGBA(150, 255, 150), "4:20Project foi injetado com sucesso.\n");
...
void __attribute__((destructor)) AyyTuxShutdown()
{
	...
	*(CamThinkSvCheatsCheck + 0x1) = 0x64;
	...
	cvar->ConsoleColorPrintf(ColorRGBA(255, 150, 150), ".so descarregado com sucesso.\n");
}
